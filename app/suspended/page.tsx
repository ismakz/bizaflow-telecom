    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center', position: 'relative', zIndex: 1, maxWidth: 400 }}>
        <div style={{
          ...
          background: 'rgba(107, 114, 128, 0.12)', border: '2px solid rgba(107, 114, 128, 0.3)',
        ...
        <p style={{ color: '#4a5e7a', fontSize: '0.9rem', lineHeight: 1.6, marginBottom: 24 }}>
          Votre compte Bizaflow Telecom a été suspendu par l&apos;administration. Si vous pensez qu&apos;il s&apos;agit d&apos;une erreur, veuillez contacter le support.
        </p>
